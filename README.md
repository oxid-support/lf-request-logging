...
> **You are on branch `b-6.5.x`** (for OXID eShop 6.5).
>
> Other supported lines:
> * **OXID 7.0** → branch [`b-7.0.x`](https://github.com/oxid-support/heartbeat-module/tree/b-7.0.x)
> * **OXID 7.1 to 7.5** → branch [`b-7.1.x`](https://github.com/oxid-support/heartbeat-module/tree/b-7.1.x)
...
* **Module 4.x**: OXID 6.5 (this branch)
...
* **`b-6.5.x`** maintenance branch for the OXID 6.5 line, Heartbeat 4.x (this branch)
